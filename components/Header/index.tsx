        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 gap-3 lg:pr-0">
                <a
                ...
                <a href="tel:9867714026" className="flex justify-center items-center gap-2 text-primary">
                  <FaPhoneAlt />
                  <span className="text-xs md:text-base cursor-pointer hidden md:block">+91-9867714026</span>
                </a>
                <div>
                  <div>
                    <ThemeToggler />
