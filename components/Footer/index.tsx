          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="https://www.webaholictech.com/" className="mb-8 inline-block">
                  <Image
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  WebaholicTech: Transforming Visions into Digital Success with Seamless Web and App Excellence!
                </p>
                <div className="flex items-center">
                 
                 
                  <a
                    href="https://www.instagram.com/webaholictech/?next=%2F"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/company/webaholictech/?viewAsMember=true"
                    aria-label="social-link"
