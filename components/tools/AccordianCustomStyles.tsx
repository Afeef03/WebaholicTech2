...
export function AccordianCustomStyles() {
  ...
  return (
    <div className="container my-12">
      ...
      {/* ======1===== */}
      <Accordion open={open === 1} className="mb-2 rounded-lg border border-blue-gray-100 px-4" icon={<Icon id={1} open={open} />} placeholder={''} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <AccordionHeader
          onClick={() => handleOpen(1)}
          className={` font-['__Inter_aaf875', '__Inter_Fallback_aaf875'] border-b-0 text-black dark:text-white transition-colors ${open === 1 ? "text-blue-500 hover:!text-blue-700" : ""}`}
          placeholder={''} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} children={"What services does WebaholicTech offer?"} />
      ...
      {/* ======2======= */}
      <Accordion open={open === 2} className="mb-2 rounded-lg border border-blue-gray-100 px-4" icon={<Icon id={1} open={open} />} placeholder={''} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <AccordionHeader
          onClick={() => handleOpen(2)}
          className={` font-['__Inter_aaf875', '__Inter_Fallback_aaf875'] border-b-0 text-black dark:text-white transition-colors ${open === 2 ? "text-blue-500 hover:!text-blue-700" : ""}`}
