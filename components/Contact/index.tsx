    ...
    <section id="contact" className="container my-12">
      <div className="relative">
        <h2 className="absolute top-0 left-0 w-full mt-75 text-4xl font-bold" style={{
          ...
          textAlign: 'center',
          top: '45%'
        }} id="AboutCompany">Connect With Us</h2>
        <h2 className="text-9xl opacity-10 text-uppercase" id="about-us-1">Contact Us</h2>
      </div>
      <div className="mx-auto max-w-6xl rounded-lg bg-gradient-to-tr from-purple-700 to-[#4A6CF7] dark:from-gray-dark dark:to-gray-darker">
        <div className="grid items-center gap-16 p-4 font-[sans-serif] sm:p-10 md:grid-cols-2">
          <div>
